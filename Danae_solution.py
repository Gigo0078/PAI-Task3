...
class Agent:
    ...
    def setup_agent(self):
        ...
        self.Tau = 0.005
        self.gamma = 0.99
        self.temperature = TrainableParameter(init_param=1, lr_param=0.01, train_param=True)
    ...
    def train_agent(self): 
        ...
        with torch.no_grad():
            ...
            min_qf_next = torch.min(qf1_next,qf2_next) - next_sampled_log_prob * alpha
        ...
        self.critic_target_update(self.critic_Q1.NN_critic, self.target_critic_Q1.NN_critic, self.Tau,True)
        self.critic_target_update(self.critic_Q2.NN_critic, self.target_critic_Q2.NN_critic, self.Tau,True)
